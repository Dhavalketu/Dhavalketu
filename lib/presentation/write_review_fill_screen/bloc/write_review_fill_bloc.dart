...
import 'package:dhavalketu_s_e_commerce_app/presentation/write_review_fill_screen/models/write_review_fill_model.dart';
...
class WriteReviewFillBloc
  ...
  _onInitialize(
    ...
    emit(state.copyWith(addreviewoneController: TextEditingController()));
  }
}
